    ...
    <div className="w-full">
      ...
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        <DropdownMenuTrigger asChild>
          <button type="button" className="w-full h-12 px-4 rounded-xl bg-slate-50 dark:bg-[#001022] text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center justify-between outline-none hover:bg-slate-100 dark:hover:bg-[#001833] transition-all focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-[#FF6B00] border border-transparent dark:border-[#002D72]/30 text-left">
        ...
        <DropdownMenuContent 
          align="start" 
          className="p-4 bg-white dark:bg-[#001833] border border-slate-100 dark:border-[#002D72]/30 rounded-2xl shadow-xl z-[150] w-72"
        >
  ...
  return (
    <div className="flex flex-col gap-6 h-full pb-36 animate-in fade-in duration-500 overflow-y-auto pr-2">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 dark:border-[#002D72]/30 pb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#002D72]/5 dark:bg-[#002D72]/20 text-[#002D72] dark:text-slate-200 border border-[#002D72]/15 dark:border-[#002D72]/30 rounded-xl font-bold text-xs uppercase tracking-widest shadow-sm hover:bg-[#002D72]/10 dark:hover:bg-[#002D72]/30 transition-all active:scale-95"
          >
          ...
          <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-slate-100 dark:bg-[#002D72]/20 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-xs uppercase tracking-widest shadow-sm hover:bg-slate-200 dark:hover:bg-[#002D72]/40 transition-all active:scale-95"
          >
      ...
      <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#002D72]/25">
        <h3 className="font-bold text-slate-800 dark:text-slate-100 uppercase text-[11px] tracking-widest mb-4 border-b border-slate-100 dark:border-[#002D72]/30 pb-2">Metadados do Projeto</h3>
      ...
      <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl border border-slate-100 dark:border-[#002D72]/25 shadow-sm flex-1">
        <div className="flex flex-col gap-4 mb-6">
          ...
          <div className="flex gap-2 items-end">
            ...
            <button 
              ...
              className="h-12 px-6 bg-[#FF6B00] text-white rounded-xl font-bold text-xs uppercase shadow-md hover:bg-[#E55A00] transition-colors flex items-center gap-2"
            >
        ...
        {data.acoes.length === 0 ? (
           <div className="flex flex-col items-center justify-center p-12 text-slate-400 dark:text-slate-600 border-2 border-dashed border-slate-200 dark:border-[#002D72]/30 rounded-xl bg-slate-50 dark:bg-[#001022]">
          ...
          <div className="flex flex-col gap-3">
            {data.acoes.map(a => (
              ...
              <div key={a.id} className="border border-slate-100 dark:border-[#002D72]/30 rounded-xl bg-white dark:bg-[#001833] shadow-sm overflow-hidden transition-all duration-300">
                {/* FIX: header do card — bg-white sem dark estava causando manchas brancas */}
                <div 
                  className="flex items-center justify-between p-4 bg-white dark:bg-[#001833] hover:bg-slate-50 dark:hover:bg-[#002D72]/30/50 cursor-pointer select-none transition-colors border-b border-slate-100 dark:border-[#002D72]/30"
                ...
                {expandedId === a.id && (
                  ...
                  <div className="p-5 grid grid-cols-2 md:grid-cols-4 gap-4 bg-white dark:bg-[#001833] border-t border-slate-100 dark:border-[#002D72]/30 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <div>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuTrigger asChild>
                          <button className="w-full h-12 px-4 rounded-xl bg-white dark:bg-[#001833] border border-slate-200 dark:border-slate-700 text-sm font-medium text-slate-700 dark:text-slate-200 flex items-center justify-between outline-none hover:bg-slate-50 dark:hover:bg-[#002D72]/30 transition-all focus:ring-2 focus:ring-[#FF6B00]">
