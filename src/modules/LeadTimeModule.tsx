    ...
    <div className="flex flex-col lg:flex-row gap-8 h-full animate-in fade-in duration-500">
      ...
      <div className="w-full lg:w-[60%] flex flex-col gap-6 overflow-y-auto pr-2 pb-36">
            ...
            <DropdownMenuContent className="w-48 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-2 rounded-2xl shadow-xl z-[150]">
              <DropdownMenuItem 
                ...
                className={`w-full text-left text-sm font-bold py-2.5 px-3 rounded-xl cursor-pointer transition-all ${
                  uBase === "minutos" ? "bg-[#0057FF] text-white" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
                }`}
              >
                Minutos
              </DropdownMenuItem>
              <DropdownMenuItem 
                ...
                className={`w-full text-left text-sm font-bold py-2.5 px-3 rounded-xl cursor-pointer transition-all ${
                  uBase === "horas" ? "bg-[#0057FF] text-white" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
                }`}
              >
                Horas
              </DropdownMenuItem>
              <DropdownMenuItem 
                ...
                className={`w-full text-left text-sm font-bold py-2.5 px-3 rounded-xl cursor-pointer transition-all ${
                  uBase === "dias" ? "bg-[#0057FF] text-white" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
                }`}
              >
                Dias
              </DropdownMenuItem>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800/80 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-slate-800/40 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#0057FF] transition-all"
      ...
      <div className="w-full lg:w-[40%] flex flex-col gap-6 overflow-y-auto pb-10">
        ...
        <div className="relative bg-white dark:bg-slate-900 p-6 border border-slate-100 dark:border-slate-800/60 rounded-2xl shadow-sm">
          ...
          <h4 className="text-[10px] font-bold text-[#0057FF] uppercase mb-3 tracking-widest border-b border-slate-100 dark:border-slate-800 pb-2">Laudo de Lead Time</h4>
