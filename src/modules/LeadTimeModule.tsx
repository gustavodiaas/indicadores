      ...
      <div className="w-full lg:w-[60%] flex flex-col gap-6 overflow-y-auto pr-2 pb-36">
        ...
        <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#4A6FA5]/35 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#4A6FA5]/30 bg-slate-50 dark:bg-[#0A2347] text-slate-800 dark:text-white text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all"
