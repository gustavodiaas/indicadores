      ...
      <div className="w-full lg:w-[60%] flex flex-col gap-6 overflow-y-auto pr-2 pb-36">
        ...
        <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#002D72]/25 flex items-center justify-between">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="h-12 px-4 rounded-xl bg-slate-50 dark:bg-[#001022] text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center justify-between gap-2 outline-none hover:bg-slate-100 dark:hover:bg-[#001833] transition-all focus:ring-2 focus:ring-[#FF6B00] border border-transparent dark:border-[#002D72]/20">
                {data.tipoSalario === "encargos" ? "Salário + Encargos" : "Salário Bruto"}
                <ChevronDown className="w-4 h-4 text-slate-400" />
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-48 bg-white dark:bg-[#001833] border border-slate-100 dark:border-[#002D72]/30 p-2 rounded-2xl shadow-xl z-[150]">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#002D72]/25 space-y-4">
            <h3 className="font-bold text-slate-800 dark:text-slate-100 text-sm tracking-wide uppercase border-b border-slate-100 dark:border-[#002D72]/30 pb-2">Estado Inicial (T1)</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all" 
              ...
              <div>
                ...
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-sm text-slate-400 dark:text-slate-500 cursor-not-allowed" value={op1} disabled />
              </div>
              <div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="w-full h-12 px-4 rounded-xl bg-slate-50 dark:bg-[#001022] text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center justify-between outline-none hover:bg-slate-100 dark:hover:bg-[#001833] transition-all focus:ring-2 focus:ring-[#FF6B00] border border-transparent dark:border-[#002D72]/20">
              ...
              <div>
                ...
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all" defaultValue={formatDec(data.dedicacaoInicial) || "100,00"} onBlur={e => onChange({ dedicacaoInicial: parseDecimal(e.target.value) || 100 })} placeholder="Ex: 100,00" />
              </div>
              {data.tipoSalario === "encargos" && (
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full h-12 px-4 rounded-xl border border-[#002D72]/30 bg-[#002D72]/5 dark:bg-[#002D72]/10 text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all"
          ...
          <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#002D72]/25 space-y-4">
            <h3 className="font-bold text-slate-800 dark:text-slate-100 text-sm tracking-wide uppercase border-b border-slate-100 dark:border-[#002D72]/30 pb-2">Estado Final (T3)</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all" defaultValue={formatDec(data.salarioBaseFinal)} onBlur={e => onChange({ salarioBaseFinal: parseDecimal(e.target.value) })} placeholder="Ex: 2500,00" />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-widest pl-1">Colaboradores</label>
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-sm text-slate-400 dark:text-slate-500 cursor-not-allowed" value={op3} disabled />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-widest pl-1">Modo de Inserção</label>
                <DropdownMenu>
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-widest pl-1">Dedicação (%)</label>
                <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all" defaultValue={formatDec(data.dedicacaoFinal) || "100,00"} onBlur={e => onChange({ dedicacaoFinal: parseDecimal(e.target.value) || 100 })} placeholder="Ex: 100,00" />
              </div>
              {data.tipoSalario === "encargos" && (
                <div className="sm:col-span-2">
                  <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-widest pl-1">
        ...
        <div className="bg-white dark:bg-[#001833] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-[#002D72]/25 space-y-4">
          <h3 className="font-bold text-slate-800 dark:text-slate-100 text-sm tracking-wide uppercase border-b border-slate-100 dark:border-[#002D72]/30 pb-2">Investimentos</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-widest pl-1">
                Porte da Empresa
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="w-full h-12 px-4 rounded-xl bg-slate-50 dark:bg-[#001022] text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center justify-between gap-2 outline-none hover:bg-slate-100 dark:hover:bg-[#001833] transition-all focus:ring-2 focus:ring-[#FF6B00] border border-transparent dark:border-[#002D72]/20">
            ...
            <div>
              ...
              <input type="text" className="w-full h-12 px-4 rounded-xl border border-transparent dark:border-[#002D72]/20 bg-slate-50 dark:bg-[#001022] text-slate-800 dark:text-slate-200 text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all" defaultValue={formatDec(data.investimentoExtra)} onBlur={e => onChange({ investimentoExtra: parseDecimal(e.target.value) })} placeholder="Investimento Extra (R$)" />
            </div>
          </div>
        </div>
      </div>
