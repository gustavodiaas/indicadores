      ...
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DropdownMenuContent align="start" className="p-4 bg-white dark:bg-[#001833] border border-slate-100 dark:border-[#4A6FA5]/40 rounded-2xl shadow-xl z-[150] w-72">
          <div className="flex items-center justify-between mb-4">
            ...
            <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); if (currentMonth === 11) { setCurrentMonth(0); setCurrentYear(y => y + 1); } else { setCurrentMonth(m => m + 1); } }} className="p-1.5 hover:bg-slate-50 dark:hover:bg-[#002D72]/30 rounded-lg text-slate-600 dark:text-slate-400 transition-all">
                    ...
                    <div className="col-span-2">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-32 bg-white dark:bg-[#001833] border border-slate-100 dark:border-[#4A6FA5]/40 p-1.5 rounded-xl shadow-xl z-[150]">
                          ...
                          <DropdownMenuItem onClick={() => updateIndicador(i.id, "status", "Concluído")} className={`w-full text-left text-[11px] font-bold py-2 px-2.5 rounded-lg cursor-pointer transition-all ${i.status === "Concluído" ? "bg-[#FF6B00] text-white" : "text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-[#002D72]/30"}`}>Concluído</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </div>
