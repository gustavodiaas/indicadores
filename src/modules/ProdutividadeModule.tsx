    ...
    <div className="flex flex-col lg:flex-row gap-6 h-full animate-in fade-in duration-500">
      <div className="w-full lg:w-[60%] flex flex-col gap-6 overflow-y-auto pr-2 pb-10">
        ...
        <div className="bg-white dark:bg-[#001833] p-5 rounded-xl border border-slate-200 dark:border-[#4A6FA5]/35 flex items-center justify-between">
          ...
          <input
            type="text"
            className="h-10 w-40 bg-slate-50 dark:bg-[#0A2347] text-slate-800 dark:text-white rounded-xl border border-transparent dark:border-[#4A6FA5]/30 text-sm font-medium outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all px-4"
            value={data.unidade}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-[#001833] p-5 rounded-xl border border-slate-200 dark:border-[#4A6FA5]/35 space-y-4">
            <h3 className="font-bold text-slate-800 dark:text-slate-100 text-sm tracking-wide uppercase border-b border-slate-200 dark:border-[#4A6FA5]/40 pb-2">
              T1 - Inicial
            </h3>
            <div>
              ...
              <input type="text" className="w-full h-10 px-3 rounded-lg border border-slate-200 dark:border-[#4A6FA5]/40 bg-slate-50 dark:bg-[#0A2347] text-slate-800 dark:text-white text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all"
            ...
            <div>
              ...
              <input type="number" className="w-full h-10 px-3 rounded-lg border border-slate-200 dark:border-[#4A6FA5]/40 bg-slate-50 dark:bg-[#0A2347] text-slate-800 dark:text-white text-sm outline-none focus:ring-2 focus:ring-[#FF6B00] transition-all"
