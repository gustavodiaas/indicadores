...
export function CalculationsDashboard({
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#1C1C1E] p-6 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm">
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Tempo Total */}
        <Card className="bg-white dark:bg-[#1C1C1E] border-slate-100 dark:border-white/10 relative overflow-hidden group">
        ...
        {/* Operação Gargalo */}
        <Card className="bg-white dark:bg-[#1C1C1E] border-rose-200 dark:border-rose-900/50 relative overflow-hidden group">
